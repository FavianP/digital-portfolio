...
export const MobileMenu = ({menuOpen,setMenuOpen}) =>{
  ...
  return (
    <div className={`fixed top-0 left-0 w-full bg-[rgba(200,100,150,0.8)] z-40 flex flex-col items-center justify-center
        ...
        " aria-label="Close Menu">
            ...
            <a>
               <a href="#home" onClick = {() => setMenuOpen(false)} className={`text-2xl font-semibold text-white my-4 transform transition-transform duration-300
                ${menuOpen ? "opacity-100 translate" : "opacity-0"}
                `}>Home</a>
